...
<input type= 'hidden' name='id' value="<?= $_GET['id'] ?>"/>
    ...
    <div class="col-md-4 mb-3">
        <label for="validationDefaultUsername">Contato</label>
        <div class="input-group">
            <input type="text" class="form-control" name="contato" id="validationDefaultUsername" aria-describedby="inputGroupPrepend2" value="<?= $result['contato'] ?>" required>
        </div>
    </div>   
    <div class="col-md-4 mb-3">
    ...
    <div class="col-md-1 mb-0">
        ...
        <input type="text" class="form-control" name="qtd" id="validationDefault02" value="<?= $result['qtd'] ?>" required>
    </div>
</br>
